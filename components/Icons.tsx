...
// Using a standardized interface for props
interface IconProps {
  className?: string;
  size?: number;
}

export const LogoIcon: React.FC<IconProps> = ({ className = "w-8 h-8", size }) => (
...
export const DiamondIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M11 3l-1 6 2 13 2-13-1-6"></path>
    <path d="M2 9h20"></path>
  </svg>
);

export const GoldBarIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ScaleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6 16a4 4 0 0 0 8 0 4 4 0 0 0 8 0"></path>
