...
import { ShieldCheckIcon, CalendarIcon, DollarSignIcon, ScaleIcon, MapPinIcon } from '@/components/Icons';
    ...
    <div className="w-full">
      ...
      <section className="relative h-screen min-h-[900px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          ...
          >
            <Link href="/book" className="group relative px-10 py-5 bg-gold overflow-hidden rounded-sm min-w-[200px]">
            ...
            <Link href="/process" className="px-10 py-5 border border-white text-white hover:bg-white hover:text-black transition-all duration-300 font-bold uppercase tracking-widest text-sm min-w-[200px]">
              How It Works
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-32 bg-deep-charcoal border-y border-gray-800">
         <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
                ...
                <Link href="/process" className="text-gold uppercase tracking-widest text-sm border-b border-gold pb-1 hover:text-white transition-colors">Learn about our technology</Link>
            </div>
         </div>
      </section>
      ...
      <section className="py-32 bg-black">
         <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               {[
                 { title: 'Gold Jewelry', subtitle: 'Any Karat (10k-24k)', img: 'https://bznwydxnqyumngwscbfy.supabase.co/storage/v1/object/public/My%20Images/1.png' },
                 { title: 'Diamonds', subtitle: 'Loose or Mounted', img: 'https://bznwydxnqyumngwscbfy.supabase.co/storage/v1/object/public/My%20Images/2.png' },
                 { title: 'Luxury Watches', subtitle: 'Rolex, Patek, AP', img: 'https://bznwydxnqyumngwscbfy.supabase.co/storage/v1/object/public/My%20Images/3.png' },
                 { title: 'Bullion & Coins', subtitle: 'Gold, Silver, Platinum', img: 'https://bznwydxnqyumngwscbfy.supabase.co/storage/v1/object/public/My%20Images/4.png' }
               ].map((item, idx) => (
                 <motion.div 
                   key={idx}
                   whileHover={{ y: -10 }}
                 ...
                 >
                   ...
                   <div className="absolute bottom-0 left-0 p-10 w-full">
                     ...
                     <Link href="/services" className="inline-block px-8 py-3 border border-white/30 text-white text-xs uppercase tracking-widest hover:bg-gold hover:border-gold hover:text-black transition-all">View Details</Link>
                   </div>
                 </motion.div>
               ))}
            </div>
      ...
      <section className="py-24 bg-deep-charcoal">
          <div className="max-w-7xl mx-auto px-4">
              <div className="flex justify-between items-end mb-16">
                  ...
                  <Link href="/blog" className="text-gold text-sm uppercase tracking-widest">Read All News →</Link>
              </div>
                  ...
                  {blogPosts.length > 0 ? (
                    blogPosts.map((post) => (
                      <Link key={post.id} href={`/blog/${post.slug}`} className="group cursor-pointer">
                        ...
                        <h4 className="text-2xl font-serif text-white group-hover:text-gold transition-colors">{post.title}</h4>
                        {post.excerpt && (
                    ...
                    // Fallback to placeholder posts if no blog posts exist
                    [
      ...
      <section className="py-32 bg-deep-charcoal border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-4">
           <div className="flex flex-col md:flex-row justify-between items-end mb-16">
              ...
              <Link href="/locations" className="text-gold hover:text-white transition-colors uppercase tracking-widest text-sm font-bold flex items-center">
      ...
      <section className="py-24 bg-black">
          <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="text-center mt-12">
                  <Link href="/faq" className="text-white text-xs border-b border-gray-600 pb-1 hover:border-white transition-colors uppercase tracking-widest">View all FAQs</Link>
              </div>
          </div>
      </section>
